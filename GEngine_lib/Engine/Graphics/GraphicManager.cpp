...
namespace ge {
	...
	void GraphicManager::Init()
	{
		...
		_basic_shapes[BasicShapes::Square] = LoadSprite(GraphicPrefabData("DebugResourses/Square.png", { 32, 32 }, 1));
		_basic_shapes[BasicShapes::Circle] = LoadSprite(GraphicPrefabData("DebugResourses/Circle.png", { 128, 128 }, 1));
