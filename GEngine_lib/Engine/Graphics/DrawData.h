...
namespace tge
{
	struct GraphicLayer
	{
		ge::Shader* layer_shader = nullptr;
...
namespace tge {
	...
	struct Sprite
	{
		...
		ge::Vector2F size; //! Размер одиночного изображения в пикселях
		ge::Vector2F sprite_pos; //! Положение верхнего левого угла изображения, с которой берёт начало спрайт
